...
public class AssetTag {
	...
	public static void setDBId(String i) {i = i.replaceAll("^0+", "");     DBId = i;}
	
	private static String Device;
	public static String getDevice() {return Device;}
	public static void setDevice(String d) {Device = d;}
	
	private static String Building;
	public static String getBuilding() {return Building;}
	public static void setBuilding(String b) {Building = b;}
	...
	public static void setPO(String p) {p = p.replaceAll("^0+", "");     PO = p;}
	
	private static String TagDate;
	public static String getTagDate() {return TagDate;}
	public static void setTagDate(String t) {t = t.substring(4, 6) + "/" + t.substring(6, 8) + "/" + t.substring(0, 4);      TagDate = t;}
